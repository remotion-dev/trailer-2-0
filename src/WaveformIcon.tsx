...
export const WaveformIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg
			aria-hidden="true"
			focusable="false"
			...
			className="svg-inline--fa fa-waveform-path fa-w-20"
			role="img"
